...
public class Ports {
    ...
    //Encoder ports
    public static final int DRIVE_ENCODER_L_A = 5;
    public static final int DRIVE_ENCODER_L_B = 4;
    public static final int DRIVE_ENCODER_R_A = 2;
    public static final int DRIVE_ENCODER_R_B = 3;

    public static final int SHOOTER_MOTOR_L = 10;
    public static final int SHOOTER_MOTOR_R = 9;
    public static final int INTAKE_MOTOR_L = 8;
    public static final int INTAKE_MOTOR_R = 7;
